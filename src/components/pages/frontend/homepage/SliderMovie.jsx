...
import { movie } from "../../backend/movies/datamovies";
const SliderMovie = ({ title, filter = "" }) => {
  const sliderRef = React.useRef();

  const getFilteredMovie = () =>
    movie.filter((item) => item.movie_category === filter);
    ...
    <>
      <section className="slider-parent bg-dark -mt-5 relative px-4">
        ...
        <button
          ...
          className="slide-nav-btn absolute top-[17.5%] z-[1] h-[180px] w-[50px] bg-black bg-opacity-60 opacity-0 transition-opacity hover:opacity-100npm"
        >
        ...
        <button
          ...
          className="slide-nav-btn absolute top-[17.5%]  right-4 z-[1] h-[180px] w-[50px] bg-black bg-opacity-60 opacity-0 transition-opacity hover:opacity-100npm"
        >
